...
const ViewerStartModalComponent = ({value, setValue}) => {
                    ...
                    <div style={{transform: "translate(-50%, -50%)"}} className="rounded-md bg-white p-16 absolute flex justify-center items-center left-1/2 top-1/2">
                        <div className="space-y-8">
                            <div>
                                ...
                                <div>
                                    <input type="text" className="w-full p-1 text-md outline-none border-b"/>
                                </div>
                            </div>
                            <div>
                                <label className="w-full py-2 px-1 font-bold">Timer(ms)</label>
                                <div>
                                    <input type="text" className="w-full p-1 text-md outline-none border-b"/>
                                </div>
                            </div>
